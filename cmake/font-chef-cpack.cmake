...
if (BUILD_SHARED_LIBS)
  set(FONT_CHEF_LIB_TYPE "shared")
else()
  set(FONT_CHEF_LIB_TYPE "static")
endif()
...
set(CPACK_PACKAGE_FILE_NAME
  "${PROJECT_NAME}-${PROJECT_VERSION}-${FONT_CHEF_SYSTEM_NAME}-${FONT_CHEF_ARCH}-${FONT_CHEF_COMPILER_TARGET}-${FONT_CHEF_LIB_TYPE}")
